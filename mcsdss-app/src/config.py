...
class MCSDSS:
    ...
    def calculate_scores(self):
        """Calculate overall scores based on weighted criteria."""
    ...
    def visualize_results(self, scores):
        ...
        self.watershed_data.plot(column='Scores', cmap='viridis', legend=True)
...
if __name__ == "__main__":
    ...
    mcsdss.set_criteria_weights({'Water Quality': 0.6, 'Biodiversity': 0.4})
